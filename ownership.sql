...
ALTER TABLE IF EXISTS s23_group48.astronaut_v2 OWNER TO s23_group48;
...
ALTER TABLE IF EXISTS s23_group48.rocket_info OWNER TO s23_group48;
ALTER TABLE IF EXISTS s23_group48.mission_info OWNER TO s23_group48;